...
public class InternalJsonComponentHologramLine extends BaseTextHologramLine implements InternalHologramLine {

    private final String serializedConfigValue;

    protected InternalJsonComponentHologramLine(InternalHologram hologram, String text, String serializedConfigValue) {
        super(hologram, text);
